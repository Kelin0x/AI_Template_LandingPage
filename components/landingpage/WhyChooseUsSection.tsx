...
import { Copy, Palette, Zap, Blocks, Sparkles, Wrench } from 'lucide-react'
  ...
  const features = [
    {
      ...
      title: "快速复用",
      description: "下载即用，只需修改内容和配置，快速构建你的网站",
      gradient: "from-blue-500 to-purple-500",
    },
    {
      icon: <Palette className="w-6 h-6" />,
      title: "样式定制",
      description: "所有组件支持自定义样式，轻松打造专属品牌形象",
      gradient: "from-purple-500 to-pink-500",
    },
    {
      icon: <Blocks className="w-6 h-6" />,
      title: "组件复用",
      description: "模块化设计的组件系统，随意组合搭配构建页面",
      gradient: "from-pink-500 to-rose-500",
    },
    {
      icon: <Sparkles className="w-6 h-6" />,
      title: "动效复制",
      description: "所有动画效果可直接复用，快速实现炫酷交互",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="flex flex-col items-start space-y-12">
            ...
            <div className="space-y-6">
              ...
              >
                <span className="text-gray-900">复制代码</span>
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">即可使用</span>
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}

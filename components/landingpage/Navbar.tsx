        ...
        <div className="flex items-center py-4">
          ...
          <div className="w-2/4 hidden md:flex justify-center">
            <div className="flex items-center space-x-12">
              {['Home', 'Feature', 'Template', 'Contact'].map((item, index) => (
                <motion.div
                  key={item}
                  className="relative"
          ...
          <div className="w-1/4 flex justify-end">
            ...
            >
              <Button
                ...
                onClick={() => window.open('https://github.com/Kelin0x', '_blank')}
              >
                <motion.div
                ...
                />
                <Github className="h-4 w-4 relative z-10 text-primary/80" />
